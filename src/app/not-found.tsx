    ...
    <>
      ...
      <main className="w-full bg-muted/50 dark:bg-muted text-foreground flex items-center justify-center">
        <section className="w-full max-w-5xl mx-auto mt-12 mb-24 grid gap-5 items-center justify-center">
          <div
            data-uia="bg-image"
            className="w-[440px] h-[320px] mx-auto aspect-auto relative"
          >
            <Image
          ...
          <p
            ...
            className="w-full text-center text-base font-normal leading-normal antialiased prose dark:prose-invert"
          >
            The page you&apos;re looking for could not be found.
          </p>

          <Button
            className="w-full h-14 shadow-2xl mt-6 p-5 bg-primary text-white text-lg leading-none antialiased"
            data-uia="cta-btn"
            role="link"
          >
